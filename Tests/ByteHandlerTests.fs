...
// DNS record  (AAAA record, 40 bytes)
...
// certificate header  (first 64 bytes of X.509)
...
let ``handles NTSecurityDescriptor`` () =
    // NTSecurityDescriptor  (2488 bytes)
