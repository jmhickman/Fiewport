...
module TestData =
    ...
    let altConfig : SearcherConfig =
        { defaultConfig with ldapDetails = { defaultLdapDetails with ldapHostname = ""; ldapIP = "10.0.0.1"} }
    ...
    let adminUser =
        mkResult GetUsers defaultLdapDetails (mkMap 
        [ "cn", ["Administrator"]
    ...
    let kerberoastTarget =
        mkResult GetKerberoastTargets defaultLdapDetails (mkMap 
        [ "cn", ["svc_backup"]
    ...
    let asrepTarget =
        mkResult GetASREPTargets defaultLdapDetails (mkMap 
        [ "cn", ["svc_asrep"]
    ...
    let dcComputer =
        mkResult GetComputers defaultLdapDetails (mkMap 
        [ "cn", ["AD-SERVER-01"]
    ...
    let builtinAdminsGroup =
        mkResult GetGroups defaultLdapDetails (mkMap 
        [ "cn", ["Administrators"]
    ...
    let domainTrust =
        mkResult GetDomainTrusts defaultLdapDetails (mkMap 
        [ "cn", ["partner.com"]
    ...
    let multipleUsers =
        mkMultiResult GetUsers defaultLdapDetails 
    ...
    let multipleGroups =
        mkMultiResult GetGroups defaultLdapDetails 
    ...
    let gpoWithSecurityExtension =
        mkResult GetGroupPolicyObjects defaultLdapDetails (mkMap 
